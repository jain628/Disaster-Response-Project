...
def index():
    ...
    genre_names = list(aid_rel1.index)
        ...
        #genre and aid_related status
    missing_people = df[df['missing_people']==1].groupby('genre').count()['message']
    death = df[df['death']==1].groupby('genre').count()['message']
    genre_names = list(missing_people.index)
    ...
    graphs = [
       ...
       
        {
            ...
            'layout': {
                'title': 'Distribution of message by genre and \'missing and died people\' class ',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
